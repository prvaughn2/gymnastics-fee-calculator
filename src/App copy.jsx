...
export default function GymnasticsFeeCalculator() {
  ...
  const handleJudgeChange = (index, e) => {
    ...
    if (["optionalRoutines", "compulsoryRoutines"].includes(name)) {
      newJudges[index][name] = Math.max(0, parseInt(value) || 0);
    } else if (["sessionRate", "meetRate", "mileage", "mileageRate", "figFee", "nationalFee", "compulsoryFee"].includes(name)) {
      ...
      {judges.map((judge, index) => (
        <Card key={index} className="mb-6 border-blue-200 shadow-lg">
          <CardContent className="space-y-6">
            ...
            <h3 className="text-base sm:text-lg font-semibold text-blue-700 mt-4">Routine Counts</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              <div>
            ...
            <h3 className="text-base sm:text-lg font-semibold text-blue-700 mt-4">Per Routine Fees</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              {judge.level === 'FIG' && (
                <div>
            ...
            <h3 className="text-base sm:text-lg font-semibold text-blue-700 mt-4">Flat Rates</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              <div>
